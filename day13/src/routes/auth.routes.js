...
//     // server token create krne ke baad token ko set krdega client ki cookie mein
...
// // one way only - plain text hash mein easily convert ho skta hai lekin hash plain text mein convert nhi ho skta
