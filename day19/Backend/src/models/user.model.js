...
const userSchema = new mongoose.Schema({
    ...
    password:{
        ...
        select: false // by default password field will not be selected when we query the user data from database. isse security badh jati hai kyuki agar kisi tarah se database me unauthorized access ho jata hai toh password field ka data leak nahi hoga.
        // drawback login ke time pe hoga kyuki hme password field ka data chahiye hota hai user ko authenticate karne ke liye. is problem ko solve karne ke liye hum login controller me user data query karte time explicitly password field ko select karenge taki hme login ke time pe password field ka data mil jaye.
    },
    bio: String,
    profileImage: {
        type: String,
